...
export class GeminiService {
  ...
  async analyzeLingerie(images: ReferenceImages, sizeInfo: string): Promise<AnalysisResponse> {
    ...
    const prompt = `
      ...
      2. Front Profile Selfie: Mirror selfie of the FIXED MODEL in her bedroom (not the room in reference image) facing a mirror and taking a picture wearing the bra she intends to sell on Depop. Realistic bust volume for "${sizeInfo}". The model is not wearing any piece of clothing from the reference image other than the bra.
